                ...
                <div className="bottom-padding">
                    <ul className='list-group'>
                        ...
                        <li className='list-group-item'>
                            ...
                            <p className="fs-5">{filmDetails.Title}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Director:</p>
                            <p className="fs-5">{filmDetails.Director}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Actors:</p>
                            <p className="fs-5">{filmDetails.Actors}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Description:</p>
                            <p className="fs-5">{filmDetails.Plot}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Year:</p>
                            <p className="fs-5">{filmDetails.Year}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Rated:</p>
                            <p className="fs-5">{filmDetails.Rated}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Length:</p>
                            <p className="fs-5">{filmDetails.Runtime}</p>
                        </li>
                        <li className='list-group-item'>
                            <p className="fs-4">Genre:</p>
                            <p className="fs-5">{filmDetails.Genre}</p>
                        </li>
                    </ul>
                </div>
            </div>
