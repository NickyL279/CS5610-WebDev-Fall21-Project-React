...
const PrivacyScreen = () => {
    return (
        <div className="container">
            ...
            <p className="text-danger">This Privacy Policy describes Our policies and procedures on the collection, use and
            ...
            <p className="text-danger">We use Your Personal data to provide and improve the Service. By using the Service,
            ...
            <p>We have no control over and assume no responsibility for the content, privacyScreen
